...
<!-- }左 -->
    ...
    <div class="right">
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
	            <tr style="font: bold;">
	            	<td>标题</td><td>分类</td><td>创建人</td><td>创建时间</td>
	            </tr>
            	<s:iterator value="pageResult.items">
	                <tr>
	                    <td height="23">
	                    <s:url var="infoViewUrl" action="home_infoViewUI" namespace="/">
	                    ...
	                    <td width="150px"><s:property value="type"/></td>
    ...
    <div class="layout_center">
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                <h1>我的投诉</h1>
                <div style="float:right;padding-top:3px;width: 9%">
                	<s:a action="home_complainAddUI" namespace="/" target="_blank">我要投诉</s:a>&nbsp;&nbsp;
                </div>
            </div>
            <table width="98%" border="0" align="center">
            	<tr style="font: bold;">
            		<td>标题</td><td>受理状态</td><td>是否匿名</td><td>投诉时间</td>
	            </tr>
            	<s:iterator value="complainList">
	                <tr>
	                    <td height="25" width="180px">
		                    <s:url var="#complainViewUrl" action="home_complainViewUI" namespace="/">
	                    ...
	                    <td width="180px"><s:property value="%{isNm==true?'匿名':'非匿名'}"/></td>
        ...
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                <h1>我的咨询</h1>
                <div style="float:right;padding-top:3px;width: 9%">
                	<s:a action="home_consultAddUI" namespace="/" target="_blank">我要咨询</s:a>&nbsp;&nbsp;
                </div>
            </div>
            <table width="98%" border="0" align="center">
            	<tr style="font: bold;">
            		<td>标题</td><td>状态</td><td>咨询时间</td>
	            </tr>
            	<s:iterator value="consultList">
	                <tr>
	                    <td height="25" width="180px">
	                    <s:url var="#consultViewUrl" action="home_consultViewUI" namespace="/">
	                    	<s:param name="consult.consId"><s:property value="consId"/></s:param>
	                    </s:url>
	                    <s:a href="%{#consultViewUrl}" target="_blank">
	                    <s:property value="consTitle"/>
	                    </s:a>
	                    </td>
	                    <td width="180px"><s:property value="#consultStateMap[state]"/></td>
	                    <td width="180px"><s:date name="%{consTime}" format="yyyy-MM-dd HH:mm"/> </td>
	                </tr>
               </s:iterator>
               </table>
        </div>
