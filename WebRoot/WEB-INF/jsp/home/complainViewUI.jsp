...
<body class="rightBody">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:property value="comp.isNm==true?'匿名':'非匿名'"/></td>
        </tr>
        <tr>
            <td class="tdBg">投诉人单位：</td>
            <td><s:property value="comp.compCompany"/></td>
        </tr>
        <tr>
            <td class="tdBg">投诉人姓名：</td>
            <td><s:property value="comp.compName"/></td>
        </tr>
        <tr>
            <td class="tdBg">投诉人手机：</td>
            <td><s:property value="comp.compMobile"/></td>
        </tr>
        ...
        <s:iterator value="comp.complainReplies">
	        <tr>
	            <td colspan="2">
	            <fieldset style="border: solid 1px #c0c0c0;margin-top:5px;"><legend style="color:green;font-weight:bold;">回复1&nbsp;</legend>
							...
							回复时间：<s:property value="replyTime"/>
							</div>
